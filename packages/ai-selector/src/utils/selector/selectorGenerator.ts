...
export function querySelector(injectedScript: Selector, selector: string, ownerDocument: Document): { selector: string, elements: Element[] } {
  try {
...
export function generateSelector(injectedScript: Selector, targetElement: Element, strict: boolean): { selector: string, elements: Element[] } {
...
function generateSelectorFor(injectedScript: Selector, targetElement: Element, strict: boolean): SelectorToken[] | null {
...
function buildCandidates(injectedScript: Selector, element: Element): SelectorToken[] {
...
function buildTextCandidates(injectedScript: Selector, element: Element, allowHasText: boolean): SelectorToken[] {
...
function cssFallback(injectedScript: Selector, targetElement: Element, strict: boolean): SelectorToken[] {
...
function chooseFirstSelector(injectedScript: Selector, scope: Element | Document, targetElement: Element, selectors: SelectorToken[][], allowNthMatch: boolean, strict: boolean): SelectorToken[] | null {
